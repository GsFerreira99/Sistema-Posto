...
class RelatorioRetiradas:
    ...
    def criar_novo_pdf(self):
        ...
        self.can.drawRightString(555, 750, f"RELATÓRIO DE RETIRADAS {self.dados['data']}")


        for nome, retiradas in self.dados['dados'].items():
            self.can.setFont('Calibri', 12)
            self.can.drawString(x, y, f"{nome.title()}")
            y-= 20
            ...
            for retirada in retiradas:
                ...
                self.can.drawString(x+50, y, f"{retirada}")
                y-=15
